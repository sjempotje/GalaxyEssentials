 ...
 */
 module.exports = async (client) => {
    ...
    client.on("messageCreate", async (message) => {
            ...
            //make a clubs database
            let clubModel = await Club.findOne({ guild: message.guild.id });
            if (!clubModel) {
                //the things it needs to save in the database:"name", "owner", "members", "description", "image", "color", "id"
                clubModel = await Club.create({
                    guild: message.guild.id,
                    name: "",
                    owner: "",
                    members: "",
